...
Config.Zones = {
    ["SandyOccasions"] = {
        ...
        zone = {
            vec3(1338.3748779297, 50.0, 2645.0153808594),
            vec3(1098.9381103516, 50.0, 2621.7487792969),
            vec3(1117.9478759766, 50.0, 2822.0729980469),
            vec3(1370.98828125, 50.0, 2859.197265625)
        },
        VehicleSpots = {
